...
function Support() {
  return (
    <div className="bg-bg-lightgrey2 mt-14">
      <div className="px-2 bg-primary2 text-white lg:px-[25rem]">
      ...
      <div className="px-3 lg:px-[25rem]">
        <h2 className="text-[28px] font-bold pt-10">Reach Us Here</h2>
        <p className="text-bg-black my-2 lg:my-4">Dedicated Support team to assist you 24/7</p>
        <div className="w-full bg-white rounded-xl shadow-2xl mb-9 pb-8">
          <div className="lg:flex lg:flex-wrap justify-start lg:px-8">
            <div className="flex lg:w-2/5 item-start m-4 pt-6">
            ...
            <div className="flex lg:w-2/5  item-start m-4 pt-4">
          ...
          <div className="bg-bg-yellow lg:flex lg:flex-row justify-center items-center w-11/12 mx-auto py-2 rounded-2xl lg:py-8">
            ...
            <img src={end_to_end} alt="end_to_end" className="w-8/12 text-center my-4  lg:my-0 lg:mx-0 mx-auto lg:w-2/5" />
          </div>
        </div>
      </div>
